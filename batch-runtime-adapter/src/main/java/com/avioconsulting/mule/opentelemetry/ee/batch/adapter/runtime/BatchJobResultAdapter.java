...
public class BatchJobResultAdapter implements BatchJobResult {
  private final com.mulesoft.mule.runtime.module.batch.api.extension.structure.BatchJobResult delegate;

  public BatchJobResultAdapter(
      com.mulesoft.mule.runtime.module.batch.api.extension.structure.BatchJobResult delegate) {
    this.delegate = delegate;
  }

  public static BatchJobResult from(
      com.mulesoft.mule.runtime.module.batch.api.extension.structure.BatchJobResult delegate) {
  ...
  public BatchStepResult getResultForStep(String stepName) {
    return new BatchStepResultAdapter(delegate.getResultForStep(stepName));
  }
