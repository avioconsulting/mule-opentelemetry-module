...
public class BatchJobResultAdapterTest {
  ...
  @Mock
  private com.mulesoft.mule.runtime.module.batch.api.extension.structure.BatchStepResult mockBatchStepResult;
  ...
  public void testGetResultForStep() {
    ...
    assertThat(result).as("Result should be an instance of BatchStepResultAdapter")
